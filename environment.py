...
class StochasticEnv:
    # Type hinting the incoming dictionaries and the RNG generator object
    def __init__(
    ...
    def step(
        ...
        return self.ego_pos.copy(), self.obstacle_pos.copy(), collision, done
